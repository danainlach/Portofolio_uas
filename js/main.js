$(window).on("load", function () {
  ...
  $(function () {
    $.iMissYou({ title: "click me !", favicon: { enabled: !1 } });
  }),
  $(window).on("load", function () {
    new Typed("#home-profile-info", { strings: ["I'm Syarah Afni...", "Front-End Developer... ", "Web Developer... ", "UI and UX Enthusiast! "], loop: !0, typeSpeed: 50, backSpeed: 30 });
  }),
  $(function () {
